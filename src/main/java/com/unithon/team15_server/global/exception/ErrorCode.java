...
public enum ErrorCode {
    ...
    INVALID_CODE(HttpStatus.BAD_REQUEST, "400-3", "유효하지 않은 코드입니다."),
    ...
    INVALID_AUTH_CODE(HttpStatus.UNAUTHORIZED, "401-6", "인증코드가 유효하지 않습니다."),
    EXPIRED_AUTH_CODE(HttpStatus.UNAUTHORIZED, "401-7", "인증코드가 만료되었습니다."),
